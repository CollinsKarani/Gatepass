...
$y=$pdf->GetY()-5;
        $pdf->SetXY(105,$y);
$pdf->CellFitScale(10, 5, 'Qty' , 1, 1,'C');
$y=$pdf->GetY()-5;
        $pdf->SetXY(115,$y);
$pdf->CellFitScale(15, 5,'Unit', 1, 1,'C');
$y=$pdf->GetY()-5;
        $pdf->SetXY(130,$y);
$pdf->CellFitScale(70, 5, 'Remarks', 1, 1);
...
$y=$pdf->GetY()-5;
        $pdf->SetXY(105,$y);
$pdf->CellFitScale(10, 5, $qty[$a], 1, 1,'C');
...
$y=$pdf->GetY()-5;
        $pdf->SetXY(130,$y);
$pdf->CellFitScale(70, 5, $remarks[$a], 1, 1);
